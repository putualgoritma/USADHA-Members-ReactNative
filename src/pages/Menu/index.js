    ...
    <View style={styles.container}>
      <View style={{flex: 1}}>
        ...
        <ScrollView>
          ...
          <View style={styles.menu}>
            <Text style={styles.titleMenu}>Reseller Order</Text>
            <SubMenu 
              titleMenu="Reseller Order" 
              icon="shopping-cart" 
              navigasi={() => navigation.navigate('Reseller')}
            />
          </View>
          <View style={styles.menu}>
            <Text style={styles.titleMenu}>Auto Maintain</Text>
            <SubMenu 
              titleMenu="Auto Maintain" 
              icon="shopping-cart" 
              navigasi={() => navigation.navigate('AutoMaintain')}
            />
          </View>
        </ScrollView>
      </View>
